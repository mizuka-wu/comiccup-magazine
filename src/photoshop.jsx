...
//   var groupIdIndex = root.artLayers.length - 1 - (leftIndex % COL_EACH_ROW) - Math.floor(leftIndex / COL_EACH_ROW) * COL_EACH_ROW * 2
//   var stallNameIndex = groupIdIndex - COL_EACH_ROW
...
//   var groupIdIndex = (root.artLayers.length - ROW_NUMBER * COL_EACH_ROW * 2) - 1 - (rightIndex % COL_EACH_ROW) - Math.floor(rightIndex / COL_EACH_ROW) * COL_EACH_ROW * 2
//   var stallNameIndex = groupIdIndex - COL_EACH_ROW
//   root.artLayers[groupIdIndex].textItem.contents = book.groupId
//   root.artLayers[stallNameIndex].textItem.contents = book.stallName
//   // 同一个社团则隐藏名字
